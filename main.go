...
func getBlockByNumber(filePath string, blockNumber int) (*Block, error) {
    ...
    if err := scanner.Err(); err != nil {
        return nil, err //error occured during scanning
    }
...
func main() {
	// Set environment variables for transactions and blocks
	os.Setenv("TRANSACTIONS", "1000")
	os.Setenv("BLOCKS", "10")

	// Access the environment variables
	transactions := os.Getenv("TRANSACTIONS")
